...
public final class ItemLayoutBinding implements ViewBinding {
  ...
  private ItemLayoutBinding(@NonNull CardView rootView, @NonNull TextView textView,
  ...
  public static ItemLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLayoutBinding((CardView) rootView, textView, tvItemName, tvPrice);
    }
