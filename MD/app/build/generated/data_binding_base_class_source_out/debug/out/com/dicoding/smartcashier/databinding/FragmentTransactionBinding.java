...
public final class FragmentTransactionBinding implements ViewBinding {
  ...
  private FragmentTransactionBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView rvHistory,
  ...
  public static FragmentTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTransactionBinding((FrameLayout) rootView, rvHistory, tvHistory);
    }
