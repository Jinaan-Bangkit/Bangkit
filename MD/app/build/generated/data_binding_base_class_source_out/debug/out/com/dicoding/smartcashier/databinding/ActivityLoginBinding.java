...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull LinearLayout rootView, @NonNull Button btnLogin,
      ...
      @NonNull TextInputEditText edtPassword, @NonNull TextInputLayout emailEditTextLayout,
      @NonNull ImageView imgLogin, @NonNull TextInputLayout passwordEditTextLayout,
      @NonNull ProgressBar progressBar, @NonNull TextView tvAccLogin, @NonNull TextView tvLogin,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((LinearLayout) rootView, btnLogin, cvLogin, edtEmail,
          edtPassword, emailEditTextLayout, imgLogin, passwordEditTextLayout, progressBar,
          tvAccLogin, tvLogin, tvNoHaveAcc, tvRegister);
    }
